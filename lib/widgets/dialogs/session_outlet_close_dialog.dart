...
part 'session_outlet_close_dialog.g.dart';

class SessionOutletCloseDialog extends ConsumerStatefulWidget {
  const SessionOutletCloseDialog({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _SessionOutletCloseDialogState();

  static Future<void> show(BuildContext context) {
    return showDialog<void>(
      context: context,
      builder: (BuildContext context) {
        return const SessionOutletCloseDialog();
      },
    );
  }
}

class _SessionOutletCloseDialogState extends ConsumerState<SessionOutletCloseDialog> {
  int cash = 0;
